...
export default function ContactInfo({ locations }: ContactInfoProps) {
  ...
  const contactMethods = [
    {
      ...
      title: 'Email',
      value: headquarters.email || 'hello@southpole.com',
      link: `mailto:${headquarters.email || 'hello@southpole.com'}`,
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/company/south-pole',
      icon: (
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/southpolegroup',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/southpolegroup',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
