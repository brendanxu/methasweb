  ...
  const displayLeadership = leadership.length > 0 ? leadership.slice(0, 8) : [
    {
      ...
      bio: 'Renat co-founded South Pole in 2006 and has been driving climate action for over 18 years.',
    ...
    },
    {
      ...
      department: 'Leadership',
      bio: 'Maximilian oversees operations and has been instrumental in South Pole\'s global expansion.',
