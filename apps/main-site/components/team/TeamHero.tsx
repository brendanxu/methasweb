...
export default function TeamHero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-700 to-green-700 py-24 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
            Passionate climate experts, innovators, and leaders working together 
            to accelerate the world's transition to a sustainable future.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-white">
              ...
              <p className="text-blue-100 text-sm">Deep expertise in climate science, technology, and sustainability</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-white">
              ...
              <p className="text-blue-100 text-sm">Diverse team with local insights and global reach</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-white">
              ...
              <h3 className="text-lg font-semibold mb-2">Passion for Impact</h3>
              <p className="text-blue-100 text-sm">United by a shared mission to combat climate change</p>
            </div>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="flex flex-col items-center text-white">
          <span className="text-sm mb-2">Meet our team</span>
