...
const Textarea = react_1.default.forwardRef(({ label, error, variant = 'default', textareaSize = 'md', className = '', ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "w-full", children: [label && ((0, jsx_runtime_1.jsx)("label", { className: "block mb-2 text-sm font-medium text-neutral-800", children: label })), (0, jsx_runtime_1.jsx)("textarea", { ref: ref, className: textareaClasses, ...props }), error && ((0, jsx_runtime_1.jsx)("p", { className: "mt-1 text-sm text-error", role: "alert", children: error }))] }));
});
