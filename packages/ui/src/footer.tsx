...
const getFooterNavigation = (language: 'zh-CN' | 'en' | 'de' | 'fr') => {
...
export function Footer() {
  ...
  return (
    <footer className="bg-neutral-50 text-neutral-900 relative overflow-hidden border-t border-neutral-200">
      {/* Main footer content */}
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-7">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Slogan */}
              <p className="mb-6 text-neutral-600 text-body-lg">
                {t.followUs}
              </p>
              
              {/* Email subscription - Professional newsletter box */}
              <div className="mb-8 bg-white rounded-xl p-6 border border-neutral-200 shadow-md">
                <h4 className="text-body-lg font-semibold mb-3 text-neutral-900">Newsletter</h4>
                <p className="text-neutral-600 text-body-sm mb-4">{t.followUs}</p>
                <form onSubmit={handleSubscribe}>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-neutral-50 text-neutral-900 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-body-sm transition-all duration-normal"
                      required
                    />
                    <button
                      type="submit"
                      className="px-6 py-3 bg-gradient-to-r from-primary-700 to-primary-500 text-white font-medium rounded-lg hover:from-primary-800 hover:to-primary-600 transition-all duration-normal text-body-sm shadow-md hover:shadow-lg hover:-translate-y-0.5"
                    >
                      {t.subscribe}
                    </button>
                  </div>
              ...
              {/* Contact info */}
              <div className="mb-8">
                <h4 className="text-body-lg font-semibold mb-3 text-neutral-900">{t.mediaContact}</h4>
                <a 
                  href="mailto:pr@miotech.com" 
                  className="text-primary-600 hover:text-primary-700 transition-colors duration-normal text-body-md"
                >
                  pr@miotech.com
                </a>
              </div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-neutral-100 rounded-lg flex items-center justify-center hover:bg-primary-500 hover:text-white transition-all duration-normal shadow-sm hover:shadow-md hover:-translate-y-0.5"
                  aria-label="LinkedIn"
                >
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-neutral-100 rounded-lg flex items-center justify-center hover:bg-success hover:text-white transition-all duration-normal shadow-sm hover:shadow-md hover:-translate-y-0.5"
                  aria-label="微信"
                >
                  <svg className="w-5 h-5 text-neutral-600" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <ul className="space-y-3">
                    {section.links.map((link, index) => (
                      <li key={index}>
                        <a
                          href={link.href}
                          className="text-neutral-600 hover:text-primary-600 transition-colors duration-normal text-body-sm leading-relaxed"
                        >
                          {link.label}
                        </a>
                      </li>
            ...
            <div className="lg:col-span-1 flex justify-center lg:justify-end">
              <div className="relative">
                {/* Professional environmental decoration - light theme */}
                <div className="w-32 h-32 bg-gradient-to-br from-primary-600 to-primary-400 rounded-full flex items-center justify-center opacity-90 shadow-lg">
                ...
                <div className="absolute -top-2 -right-2 w-4 h-4 bg-accent-amber rounded-full animate-pulse shadow-sm"></div>
                <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-success rounded-full animate-pulse delay-500 shadow-sm"></div>
                <div className="absolute top-1/2 -right-4 w-2 h-2 bg-accent-blue rounded-full animate-pulse delay-1000 shadow-sm"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-neutral-500 hover:text-primary-600 text-body-sm transition-colors duration-normal">
                {t.privacyPolicy}
              </a>
              <a href="#" className="text-neutral-500 hover:text-primary-600 text-body-sm transition-colors duration-normal">
                {t.termsOfService}
